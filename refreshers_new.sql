delimiter $$
create definer = rklem@localhost procedure refresh_new_mv_compiler_regression__berkelium_by_conf()
BEGIN
START TRANSACTION;
...
create definer = rklem@localhost procedure refresh_new_mv_compiler_regression__helium_links()
BEGIN
START TRANSACTION;
...
create definer = rklem@localhost procedure refresh_new_mv_compiler_regression__helium_sum_by_build()
BEGIN
START TRANSACTION;
...
create definer = rklem@localhost procedure refresh_new_mv_compiler_regression__urisc_by_branch()
BEGIN
	START TRANSACTION;
...
create definer = rklem@localhost procedure refresh_new_mv_compiler_regression__urisc_links()
BEGIN
	START TRANSACTION;
...
create definer = rklem@localhost procedure refresh_new_mv_compiler_regression__urisc_sum_by_build()
BEGIN
	START TRANSACTION;
...
create definer = rklem@localhost procedure refresh_new_mv_compiler_regression__uvliw_by_branch()
BEGIN
	START TRANSACTION;
...
create definer = rklem@localhost procedure refresh_new_mv_compiler_regression__uvliw_links()
BEGIN
	START TRANSACTION;
...
create definer = rklem@localhost procedure refresh_new_mv_compiler_regression__uvliw_sum_by_build()
BEGIN
	START TRANSACTION;
